...
class TestWsStaleReconnect(unittest.TestCase):
    def test_stale_threshold_is_at_least_30_seconds(self) -> None:
    ...
    def test_testnet_cached_tickers_still_reconnect_when_age_exceeds_30s(self) -> None:
        ...
        ), patch.object(Config, "WS_STALE_SECONDS", 30):
