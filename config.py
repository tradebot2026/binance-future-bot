...
class Config:
    ...
    BALANCE_CACHE_TTL_SECONDS: int = _env_int("BALANCE_CACHE_TTL_SECONDS", 300)
    BALANCE_REST_POLL_SECONDS: int = _env_int("BALANCE_REST_POLL_SECONDS", 300)
    POSITION_CACHE_TTL_SECONDS: int = _env_int("POSITION_CACHE_TTL_SECONDS", 120)
    POSITION_CACHE_BACKOFF_SECONDS: int = _env_int("POSITION_CACHE_BACKOFF_SECONDS", 300)
    REST_TOKEN_BUCKET_CAPACITY: int = _env_int("REST_TOKEN_BUCKET_CAPACITY", 80)
    REST_TOKEN_REFILL_PER_SECOND: float = _env_float(
        "REST_TOKEN_REFILL_PER_SECOND", 1.2
    )
    REST_BLOCK_LOG_INTERVAL_SECONDS: int = _env_int(
        "REST_BLOCK_LOG_INTERVAL_SECONDS", 600
    )
    REST_NETWORK_MAX_RETRIES: int = _env_int("REST_NETWORK_MAX_RETRIES", 2)
