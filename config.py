...
class Config:
    ...
    TICKER_REST_FALLBACK_AFTER_SECONDS: float = _env_float(
        "TICKER_REST_FALLBACK_AFTER_SECONDS", 10.0
    )
    TICKER_REST_MIN_INTERVAL_SECONDS: float = _env_float(
        "TICKER_REST_MIN_INTERVAL_SECONDS", 30.0
    )
    ...
    WS_RECONNECT_MAX_SECONDS: float = _env_float("WS_RECONNECT_MAX_SECONDS", 120.0)
    WS_RECONNECT_LOG_INTERVAL_SECONDS: int = _env_int(
        "WS_RECONNECT_LOG_INTERVAL_SECONDS", 60
    )
    WS_HEALTH_CHECK_SECONDS: int = _env_int("WS_HEALTH_CHECK_SECONDS", 30)
    ...
    WS_KLINE_BOOTSTRAP_REST_DELAY_SECONDS: float = _env_float(
        "WS_KLINE_BOOTSTRAP_REST_DELAY_SECONDS", 0.0
    )
