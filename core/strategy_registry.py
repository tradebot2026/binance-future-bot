...
def strategy_enable_flag(tag: str) -> bool:
    ...
    flags = {
        ...
        "BREAKOUT_RETEST": Config.ENABLE_STRATEGY_BREAKOUT_RETEST,
        "TREND_MOMENTUM": Config.ENABLE_STRATEGY_TREND_MOMENTUM,
        "VOL_SQUEEZE": Config.ENABLE_STRATEGY_VOL_SQUEEZE,
        "ORDER_FLOW": Config.ENABLE_STRATEGY_ORDER_FLOW,
        "OI_FUNDING": Config.ENABLE_STRATEGY_OI_FUNDING,
        "VP_KEYLEVEL": Config.ENABLE_STRATEGY_VP_KEYLEVEL,
        "MTF_ALIGNMENT": Config.ENABLE_STRATEGY_MTF_ALIGNMENT,
        "FALSE_BREAKOUT_SFP": Config.ENABLE_STRATEGY_FALSE_BREAKOUT_SFP,
        "PRICE_ACTION_REVERSAL": Config.ENABLE_STRATEGY_PRICE_ACTION_REVERSAL,
    }
